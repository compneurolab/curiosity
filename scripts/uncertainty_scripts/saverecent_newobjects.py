...
ACTIONS_GIVEN = [-2, -1, 1]
OBJTHERE_TEST_METADATA_LOC = '/media/data4/nhaber/one_room_dataset/damianobjects/val_diffobj_all_meta.pkl'
...
std_shape_names = ['Arrow', 'AssymCone', 'Capsule', 'Cone',
...
dp_config = {
                ...
                'environment_params' : {
                        'random_seed' : 1,
                        'standard_shapes' : std_shape_names,
                        'unity_seed' : 1,
                        'room_dims' : room_dims,
                        'state_memory_len' : {
                        ...
                        'rng_periodicity' : 1,
                        'termination_condition' : environment.obj_not_present_conservative_oob_termination_condition,
...
validate_params = {
            'func' : update_step.ReadoutEvaluator,
            'kwargs' : {},
            'num_steps' : 100,
}
...
load_and_save_params = cfg_generation.query_gen_latent_save_params(location = 'freud', prefix = EXP_ID_PREFIX, state_desc = 'images1', 
			portnum = cfg_generation.NODE_5_PORT, load_and_save_elsewhere = True)


load_and_save_params['save_params']['save_to_gfs'] = ['batch', 'msg', 'recent', 'map_draw']
#load_and_save_params['what_to_save_params'] = {'num_back_to_save' : 3}
...
get_recent_postprocessor = lambda params : SaveRecentPostprocessor(**params)


postprocessor_params = {
        'func' : get_recent_postprocessor
}
...
params['save_params']['collname'] = 'newobj'
