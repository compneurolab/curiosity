...
from curiosity.interaction import train, environment, data, static_data, cfg_generation, update_step
...
dp_config = {
                ...
                'provider_params' : {
                        ...
                        'capacity' : 5,
                        'gather_per_batch' : args['gather'] / args['numberofenvironments'],
...
params['load_params']['exp_id'] = 'dr_vfl4o6t3'
