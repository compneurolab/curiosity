...
parser.add_argument('--stdobjnum', default=0, type = int)
...
ACTIONS_GIVEN = [-2, -1, 1]
OBJTHERE_TEST_METADATA_LOC = '/media/data4/nhaber/one_room_dataset/damianobjects/val_diffobj' + str(args['stdobjnum']) + '.hdf5'
...
std_obj_name = std_shape_names[args['stdobjnum']]
