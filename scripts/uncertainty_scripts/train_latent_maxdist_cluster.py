...
ACTIONS_GIVEN = [-2, -1, 1]
OBJTHERE_TEST_METADATA_LOC = '/data/nhaber/one_room_dataset/maxdist/val_diffobj_all_meta_cluster.pkl'
...
encoding_size = int(np.prod(dims_encoding) * wm_encoding_choice['num_filters'][-1])
print('Latent encoding size! ' + str(1152))
encoding_size = int(1152)
...
load_and_save_params = cfg_generation.query_gen_latent_save_params(location = 'cluster', prefix = EXP_ID_PREFIX, state_desc = 'images1', 
...
params['save_params']['collname'] = 'latent_md'
