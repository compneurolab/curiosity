...
ACTIONS_GIVEN = [-2, -1, 1]
OBJTHERE_TEST_METADATA_LOC = '/data/nhaber/one_room_dataset/torque/val_diffobj_all_meta_cluster.pkl'
...
n_classes_wm = args['nclasses']
act_thresholds = [-1. + 2. * float(k) / float(n_classes_wm) for k in range(1, n_classes_wm)]
...
load_and_save_params = cfg_generation.query_gen_latent_save_params(location = 'damian', prefix = EXP_ID_PREFIX, state_desc = 'images1', portnum = cfg_generation.NODE_5_PORT)
...
params['save_params']['collname'] = 'share_enc'
