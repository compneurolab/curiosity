...
UNIFORM_METADATA_LOC = '/media/data2/nhaber/train_uniform_repeat.pkl'
OBJTHERE_METADATA_LOC = '/media/data2/nhaber/train_objthere_repeat.pkl'

STATE_STEPS = [-1, 0]
STATES_GIVEN = [-3, -2, -1, 0, 1, 2, 3]
ACTIONS_GIVEN = [-3, -2, -1]
...
wm_cfg = {
	...
	'states_given' : STATES_GIVEN,
	'actions_given' : ACTIONS_GIVEN,
	'act_dim' : ACTION_DIM,
...
def get_static_data_provider(data_params, model_params, action_model):
	...
	data_params_copy.pop('func')
        return static_data.BetterOfflineDataProvider(**data_params_copy)
