...
save_filename = '/data2/mrowca/datasets/one_room_dataset/pos_dataset/' + str(int(force_scaling)) + '_' + tasknum + '.hdf5'
room_dims = (5., 5.)
state_time_length = 2
...
data_params = {
                ...
                'environment_params' : {
                        ...
                        'state_memory_len' : {
                                        ...
                                        'objects1': history_len + state_time_length + 1,
                                },
                ...
                'provider_params' : {
                    'batching_fn' : lambda hist : data.uniform_experience_replay(hist, history_len, my_rng = my_rng, batch_size = batch_size, data_lengths={'obs' : {'depths1' : 3, 'objects1': 3}, 'action' : 2, 'action_post' : 2}),
                        'capacity' : 5,
