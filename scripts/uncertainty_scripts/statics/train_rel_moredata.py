...
UNIFORM_METADATA_LOC = '/media/data2/nhaber/train_uniform_rel200.pkl'
OBJTHERE_METADATA_LOC = '/media/data2/nhaber/train_objthere_rel200.pkl'
STATE_STEPS = [-1, 0]
