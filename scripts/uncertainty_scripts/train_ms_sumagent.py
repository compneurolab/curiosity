...
wm_cfg = {
	'num_timesteps' : 3,
	'state_shape' : [T_PER_STATE] + list(IMAGE_SCALE) + [3],
	'act_dim' : ACTION_DIM,
	'encode' : cfg_generation.generate_conv_architecture_cfg(**{'sizes' : [3, 3, 3, 3], 'strides' : [2, 2, 2, 2], 'num_filters' : [32, 32, 32, 32], 'bypass' : [None, None, None, None]}),
	'action_model' : {
...
def get_ms_models(cfg):
	world_model = models.MSActionWorldModel(cfg['world_model'])
