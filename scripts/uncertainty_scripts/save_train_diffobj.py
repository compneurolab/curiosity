...
parser.add_argument('--justrandom', default=1, type = int)
...
if render_node == 1:
    ...
    RENDER1_HOST_ADDRESS = cfg_generation.get_ip('node10')
...
if USER == 'nick':
    ...
    OBJTHERE_TEST_METADATA_LOC = '/data2/mrowca/datasets/one_room_dataset/pos_dataset/diffobj_train' + str(args['objseed']) + '.hdf5'
