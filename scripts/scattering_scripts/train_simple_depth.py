'''
Simple depth with correlation loss.
'''
...
EXP_ID_PREFIX = 'cfgsrch'
model_func = modelsource.stripped_down_depths_model
model_cfg_gen = modelsource.gen_cfg_no_explicit_alt


some_cfg_kwargs = [{'encode_num_filters' : [4, 8, 16, 32],
		...
		{'encode_num_filters' : [34, 34, 34],
                                'encode_pool' : [True, False, False],
                                'encode_size' : [7, 7, 7],
                                'encode_bypasses' : [None, None, 0],
                                'encode_stride' : [2, 2, 2],
                                'together_num_filters' : [24],
                                'together_size' : [1],
                                'together_max_pool' : [False],
                                'together_bypasses' : [0],
                                'hidden_num_features' : [1000, 1000]},
		{'encode_num_filters' : [4, 8, 16],
                                'encode_pool' : [True, False, False],
                                'encode_size' : [7, 7, 7],
                                'encode_bypasses' : [None, None, 0],
                                'encode_stride' : [2, 2, 2],
                                'together_num_filters' : [20],
                                'together_size' : [1],
                                'together_max_pool' : [False],
                                'together_bypasses' : [0],
                                'hidden_num_features' : [2000, 2000]},
		{'encode_num_filters' : [4, 8, 16, 32, 64],
                                'encode_pool' : [True, False, False, False, False],
                                'encode_size' : [7, 7, 7, 3, 3],
                                'encode_bypasses' : [None, None, None, 0, 0],
                                'encode_stride' : [2, 2, 2, 2, 1],
                                'together_num_filters' : [32],
                                'together_size' : [1],
                                'together_max_pool' : [False],
                                'together_bypasses' : [0],
                                'hidden_num_features' : [2000, 2000]},
		{'encode_num_filters' : [4],
                                'encode_pool' : [True],
                                'encode_size' : [7],
                                'encode_bypasses' : [None],
                                'encode_stride' : [2],
                                'together_num_filters' : [8, 16, 32, 64],
                                'together_size' : [7, 7, 3, 3],
                                'together_max_pool' : [True, True, False, False],
                                'together_bypasses' : [None, None, 0, 0],
                                'hidden_num_features' : [2000, 2000]}]

learning_rate = 1e-5
#filters at end, encode depth, features in hidden, hidden depth
some_cfg_tuples = [([4, 8, 16, 32], 32, 4, 250, 3), ([2, 4, 8, 16], 16, 4, 500, 3), ([4, 8, 16, 32, 64], 64, 5, 2000, 4)]
drop_keep = .75
...
if __name__ == '__main__':
	...
	cfg_kwargs = some_cfg_kwargs[cfg_version]
	cfg = model_cfg_gen(**cfg_kwargs)
