...
def just_two_and_three(path):
	all_filenames = os.listdir(path)
	return [os.path.join(path, fn) for fn in all_filenames if fn.startswith('2') or fn.startswith('3')]
...
#		'cfg' : model_cfg,
	...
	'train_params' : {
		...
		'data_params' : {
			...
			'file_grab_func' : just_two_and_three,
		},
