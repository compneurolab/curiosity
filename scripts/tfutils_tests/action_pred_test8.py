...
import curiosity.models.tf_action_pred_sequence_discrete_finetune as modelsource
...
params = {
    ...
    'loss_params': {
        'targets': ['poses', 'future_poses'],
        'agg_func': tf.reduce_mean,
        'loss_per_case_func': modelsource.softmax_cross_entropy_pose_diff_loss,
    },
