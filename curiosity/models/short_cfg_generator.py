...
N_PARAMS_LIST = [25000 * (2**n) for n in range(9)]
N_END = N_TIMESTEPS_PREDICT * 2
N_HIDDEN_LAYERS_LIST = [2, 2, 2, 2, 2, 4, 6, 8, 10]
N_ENCODING_LAYERS_LIST = [1, 2, 3, 3, 3, 3, 3, 4, 4, 4]
POSSIBLE_ENCODING_SIZES = [7, 5, 3, 1]
N_FILTERS_LIST = [10 * n for n in range(1, 6)]
STRIDE_CHOICES = [1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
IMG_HEIGHT = 160
IMG_WIDTH = 375
WRITE_LOC = '/mnt/fs0/nhaber/projects/curiosity/curiosity/configs/cfg_gen_1.pkl'
STARTS_WRITE_LOC = '/mnt/fs0/nhaber/projects/temp/started_small1.pkl'
...
def generate_encoding():
	...
	for i in range(1, encode_depth + 1):
		k_size = my_rng.choice([sz for sz in POSSIBLE_ENCODING_SIZES if sz <= size_max])
		size_max = k_size
		...
		stride = my_rng.choice(STRIDE_CHOICES)
		cfg['encode'][i] = {
